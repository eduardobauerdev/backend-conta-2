...
export async function POST(request: Request) {
  console.log("[v0] ⚡⚡⚡ FUNÇÃO POST INICIADA - CALLBACK JURÍDICA ⚡⚡⚡")
  
  try {
    console.log("[v0] =================================")
    console.log("[v0] CALLBACK CONTRATO JURÍDICA RECEBIDO")
    console.log("[v0] =================================")
    ...
    storeCallback(callbackId, finalLink, 'contrato-juridica')
