...
"[project]/app/api/whatsapp/quick-reply-categories/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data, error } = await supabase.from("quick_reply_categories").select("*").order("name", {
            ascending: true
        });
        if (error) {
...
async function POST(request) {
    try {
        ...
        const { data, error } = await supabase.from("quick_reply_categories").insert({
            name: name.trim(),
...
async function DELETE(request) {
    try {
        ...
        if (replies && replies.length > 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "Não é possível deletar categoria com respostas rápidas associadas"
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52d34419._.js.map