...
function QRScanner({ onConnected }) {
            ...
            const channel = supabase.channel('qr_scanner_updates').on('postgres_changes', {
                ...
                "QRScanner.useEffect.channel": (payload)=>{
                    ...
                    if (newData.status === 'connected') {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Conectado com sucesso!");
                        onConnected();
    ...
    async function startSession() {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Iniciando servidor...", {
                description: "Aguarde o QR Code aparecer."
            });
        } catch (error) {
            console.error("[QRScanner] Erro:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Erro de conexão.");
            setLoading(false);
        }
    }
    // 3. Cancelar Sessão
    async function stopSession() {
        try {
            ...
            setSessionActive(false);
            setQrImage(null);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Sessão cancelada.");
        } catch (e) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao cancelar.");
        }
    }
    // --- RENDERIZAÇÃO ---
    if (loading && !qrImage) {
...
function AjustesPage() {
    ...
    async function handleWhatsappUrlChange(value) {
        ...
        try {
            ...
            if (response.ok) {
                setUrlSaved(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("URL salva");
            }
        } catch (error) {
    ...
    async function handleDisconnectWhatsApp() {
        ...
        try {
            ...
            if (response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Solicitação enviada");
            // O Realtime vai atualizar o estado para desconectado automaticamente
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao desconectar");
            }
        } catch (error) {
    ...
    function handleWhatsAppConnected() {
        ...
        setShowQR(false);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Conectado!");
    }
...
//# sourceMappingURL=_e5bdf5e2._.js.map