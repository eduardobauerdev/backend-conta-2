...
function UserProvider({ children }) {
    ...
    const loadUser = async ()=>{
        try {
            const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserIdFromCookie"])();
            if (userId) {
                ...
                userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserData"])(userId);
                if (userData) {
    ...
    const refreshUser = async ()=>{
        try {
            ...
            if (userId) {
                userCache.delete(userId);
                const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserData"])(userId);
                if (userData) {
                    setCachedUser(userId, userData);
                    setUser(userData);
                }
...
"[project]/components/auth-guard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthGuard({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthGuard.useEffect": ()=>{
            ...
            const authenticated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAuthenticated"])();
            if (!authenticated) {
                router.push('/login');
                return;
            }
...
"[project]/contexts/realtime-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RealtimeProvider({ children }) {
    ...
    const callbacksRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
//# sourceMappingURL=_116b3733._.js.map